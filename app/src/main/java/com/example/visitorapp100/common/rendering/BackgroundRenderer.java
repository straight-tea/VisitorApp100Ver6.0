...
public class BackgroundRenderer {
  ...
  public void createOnGlThread(Context context, int depthTextureId) throws IOException {
    ...
    {
      int vertexShader =
          com.google.ar.core.examples.java.common.rendering.ShaderUtil.loadGLShader(TAG, context, GLES20.GL_VERTEX_SHADER, CAMERA_VERTEX_SHADER_NAME);
      int fragmentShader =
          com.google.ar.core.examples.java.common.rendering.ShaderUtil.loadGLShader(
      ...
      com.google.ar.core.examples.java.common.rendering.ShaderUtil.checkGLError(TAG, "Program creation");

      cameraTextureUniform = GLES20.glGetUniformLocation(cameraProgram, "sTexture");
      com.google.ar.core.examples.java.common.rendering.ShaderUtil.checkGLError(TAG, "Program parameters");
    }
  ...
  private void draw(boolean debugShowDepthMap) {
    ...
    com.google.ar.core.examples.java.common.rendering.ShaderUtil.checkGLError(TAG, "BackgroundRendererDraw");
  }
